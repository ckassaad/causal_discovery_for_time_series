...
def get_ground_truth(structure, nodes):
    ...
    elif structure == "dsr_v_structure":
...
def run_on_data(i, method, structure, n_samples, files_input_name, verbose):
    ...
    data = pd.read_csv('./data/simulated_ts_data_different_sampling_rate/' + structure + '/' + file_input_name, index_col=0, header=0, delimiter=',')
...
if __name__ == "__main__":
    ...
    path_input = './data/simulated_ts_data_different_sampling_rate/' + structure
