...
parser.add_argument('--data', type = str,  default = 'data/syntheticB/filter_norm_expression0.mat')
parser.add_argument('--graph_path', type = str, default = 'data/syntheticB/groundtruth.mat')
parser.add_argument('--GTu_path', type = str,  default = 'data/syntheticB/groundtruth.mat')
parser.add_argument('--y_dim', type = int,  default = 130)

parser.add_argument('--model', type = str, default = 'DCM_DeepCausal')

parser.add_argument('--window', type = int, default = 10)
parser.add_argument('--pre_win', type = int, default = 5)
parser.add_argument('--horizon', type = int,  default = 1)


parser.add_argument('--lowrank', type = int, default = 75)
parser.add_argument('--p_list_number', type = int, default = 40)
parser.add_argument('--p_list_layer', type = int, default = 6)
parser.add_argument('--compress_p_list', type = str, default = '50')
...
def train(loader, data, model, criterion, optim, batch_size, GroundTruth_flat, lambda1):
    model.train();
    total_loss = 0
    mse = 0
    n_samples = 0
    ...
    for inputs in loader.get_batches_bi(data, batch_size, True):      
        ...
        batch_loss = loss_org + abs(l2_reg)*lambda1+ abs(otg_reg)*0.1 
...
for epoch in range(0, args.epochs):
    ...
    train_loss, mse, epoch_time = train(Data, Data.train_bi, model, criterion, optim, args.batch_size, GroundTruth_flat,args.lambda1)
