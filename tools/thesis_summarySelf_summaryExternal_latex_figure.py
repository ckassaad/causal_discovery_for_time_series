    ...
    for structure in structure_list:
        ...
        for type_of_causes in ["summary_other", "summary_other", "summary_self"]:
            ...
            if type_of_causes == "summary_other":
                all_methods_list = ['PCTMIwindow=auto_new_lambda', 'NBCB', 'NBCB_pw', 'PWNBCBk', 'GrangerPW', 'GrangerMV', 'TCDF',
                ...
                all_methods_list = ['PCTMIwindow=auto_new_lambda', 'NBCB', 'NBCB_pw', 'PWNBCBk', 'oCSE', 'TCDF', 'PCMCICMIknn', 'PCMCIParCorr', 'VarLiNGAM']
                methods_treats_hidden = []
