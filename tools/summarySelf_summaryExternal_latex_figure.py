if __name__ == "__main__":
    ...
    path_output = "../experiments/performance_average/latex_format/figures" + "/" + measure_name + \
                  "_summarySelf_summaryExternal_latex_figure_.txt"
    ...
    for structure in structure_list:
        ...
        for type_of_causes in ["summary_other", "summary_other", "summary_self"]:
            ...
            if type_of_causes == "summary_other":
                ...
                all_methods_list = ['TCDF', 'PCMCICMIknn', 'PCMCIParCorr', 'oCSE', 'tsFCI', 'VarLiNGAM']
    ...
    f_o.write("\\caption"
            "[Detailed perfomances]{Adjacency, external causation and self causation in the summary causation graph for all the methods on 5 simulated datasets. We study the F1 score (mean $\pm$ standard deviation). Results  are computed for various time grid sizes, from 125 to 4000. A log-scale is used in abscissa.}"
