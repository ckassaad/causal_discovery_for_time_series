...
def run_on_data(i, method, files_input_name, verbose):
    ...
    data = pd.read_csv('./data/FinanceCPT/returns/selected/sparse/' + file_input_name, delimiter=',', index_col=False, header=None)
    ...
    file_ground_truth_name = files_input_name[i].split('_returns')[0]
    three_col_format_ground_truth = np.loadtxt('./data/FinanceCPT/ground_truth/' + file_ground_truth_name + '.csv',
                                               delimiter=',')
    ...
    if save_model:
        nx.write_gpickle(model.ghat, "./experiments/graphs/summary_other_and_self_graphs/finance/" + method + "_" + str(i))
        nx.write_gpickle(model.oghat, "./experiments/graphs/summary_other_graphs/finance/" + method + "_" + str(i))
        nx.write_gpickle(model.sghat, "./experiments/graphs/summary_self_graphs/finance/" + method + "_" + str(i))
    ...
    if not isinstance(model, cd.TemporalGraphicalModel):
        ...
        if save_model:
            nx.write_gpickle(model.tghat, "./experiments/graphs/temporal_graphs/finance/" + method + "_" + str(i))
        # evaluation temporal
...
if __name__ == "__main__":
    ...
    path_input = './data/FinanceCPT/returns/selected/sparse/'
    ...
    with open("./experiments/performance_average/summary_other_and_self_performance_average/" + str(method) + "_finance", "w+") as file:
    ...
    with open(
            "./experiments/performance_average/summary_other_performance_average/" + str(method) + "_finance",
            "w+") as file:
    ...
    with open(
            "./experiments/performance_average/summary_self_performance_average/" + str(method) + "_finance",
            "w+") as file:
    ...
    if results.shape[1] > 16:
        ...
        with open(
                "./experiments/performance_average/temporal_performance_average/" + str(method) + "_finance",
                "w+") as file:
        ...
        np.savetxt("./experiments/performance_detail/" + str(method) + "_finance.csv", results,
